...
public class BlobStoreValidator {
  ...
  static final String LIST_OBJECT_VERSIONS_MAX_RESULTS_MSG =
      "ListObjectVersionsRequest maxResults must be positive when specified";
  ...
  public void validate(ListObjectVersionsRequest request) {
    ...
    if (request.getMaxResults() != null && request.getMaxResults() <= 0) {
      throw new IllegalArgumentException(LIST_OBJECT_VERSIONS_MAX_RESULTS_MSG);
    }
  }
